...
Given a correct and secure \UKA scheme, then the $1$ out of $n$ oblivious transfer in \figureref{fig:KAtoOT}   is an endemic $\OT_{1,n}$ in the programmable random oracle model. 
