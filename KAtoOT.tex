...
Given a correct and secure [one-round] \UKA scheme, then the $1$-out-of-$n$ oblivious transfer in [\figureref{fig:oneroundKAtoOT}] \figureref{fig:KAtoOT}   is an Endemic $\OT$ in the programmable random oracle model. 
\end{theorem}
