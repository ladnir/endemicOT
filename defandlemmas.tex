...
In the following, we present a generalized definition of OT. 
...
The next transformation is useful in the context of OT extension where it can be an advantage if the receiver's choice bit is chosen at random.
\begin{figure}
\centering
\framebox{
\begin{tikzpicture}
