...
\begin{lemma} \label{lem:malRec}
	...
	$$
	where $\Pi^{\textsf{OOS}}$ is the protocol in \definitionref{def:OOS} and all algorithms additionally receive input $1^\kappa$. 
\end{lemma}
\iffullversion
