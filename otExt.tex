...
\begin{proof}
	...
	\begin{claim}[Malicious Sender Security]\label{claim:ext-E-MalSender}
		$\Pi^\textsf{ext-E}$ satisfies security against a malicious ender (\definitionref{def:otSec}) with respect to the $\OOT^\E$ functionality.
	\end{claim}
	\begin{proof}
