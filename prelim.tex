...
\item[Sender Chosen Message (SCM) Security:] The OT is secure with respect to $\OOT^{\send}$.
\item[Receiver Chosen Message (RCM) Security:] The OT is secure with respect to $\OOT^{\rec}$.
